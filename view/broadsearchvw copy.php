 ...
 <body>
         ...
         <div class="container-fluid">
             ...
             <div class="form-group">
                 <div class="input-group">
                     ...
                     <select id="slot" multiple name="slot" placeholder="Select Time Slot" data-silent-initial-value-set="false">
                         <option value="0">7am-11am</option>
                         <option value="1">11am-2pm</option>
                         <option value="2">2pm-6pm</option>
                         <option value="3">6pm-10pm</option>
                         <option value="4">10pm-12am</option>
                     </select>
     ...
     <script>
         ...
         $(document).ready(function() {
             ...
             $('#search_text, select[name="category"], select[name="slot"]').on('keyup change', function() {
