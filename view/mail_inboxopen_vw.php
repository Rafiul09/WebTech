            ...
            <table width="1000" align="center">
                ...
                <tr>
                    ...
                    <form action="../controller/mailctrl.php" method="post">
                        ...
                        <td align="right">
                            ...
                            From: <input type="text" name="name" size="130" value="<?php echo $DfirstName . ' ' . $DlastName; ?>" readonly><br>
                ...
                <tr>
                    <td align="right">
                        ...
                        <br>
                        <a href="mail_out.php"><button type="button">
                                << To Outbox</button></a>
                        <button type="submit" name="mreply">Send a Reply >></button>
                    </td>
                </tr>
